...
local FullStep = STATSMAN:GetCurStageStats():GetPlayerStageStats(PLAYER_2):GetTapNoteScores("TapNoteScore_W1") + STATSMAN:GetCurStageStats():GetPlayerStageStats(PLAYER_2):GetTapNoteScores("TapNoteScore_W2") + STATSMAN:GetCurStageStats():GetPlayerStageStats(PLAYER_2):GetTapNoteScores("TapNoteScore_W3") + STATSMAN:GetCurStageStats():GetPlayerStageStats(PLAYER_2):GetTapNoteScores("TapNoteScore_W4") + STATSMAN:GetCurStageStats():GetPlayerStageStats(PLAYER_2):GetTapNoteScores("TapNoteScore_W5") + STATSMAN:GetCurStageStats():GetPlayerStageStats(PLAYER_2):GetTapNoteScores("TapNoteScore_Miss")
...
local Perfect = string.sub(Space..STATSMAN:GetCurStageStats():GetPlayerStageStats(PLAYER_2):GetTapNoteScores("TapNoteScore_W1")+STATSMAN:GetCurStageStats():GetPlayerStageStats(PLAYER_2):GetTapNoteScores("TapNoteScore_W2"), -4);
...
t[#t+1] = Def.ActorFrame{
	InitCommand=cmd(player,PLAYER_2;y,-100);
	...
	LoadFont("2ndMIXJudgePercent")..{
		InitCommand=cmd(addx,134;addy,8;horizalign,left;);
		OnCommand=function(self)
...
--Great--
t[#t+1] = Def.ActorFrame{
	InitCommand=cmd(player,PLAYER_2;y,-54);
	LoadFont("2ndMIXJudgeNum.ini")..{
		InitCommand=cmd(horizalign,left;);
		OnCommand=function(self)
			self:settextf(Great);
...
--Good--
t[#t+1] = Def.ActorFrame{
	InitCommand=cmd(player,PLAYER_2;y,-10);
	LoadFont("2ndMIXJudgeNum.ini")..{
		InitCommand=cmd(horizalign,left;);
		OnCommand=function(self)
			self:settextf(Good);
...
--Boo--
t[#t+1] = Def.ActorFrame{
	InitCommand=cmd(player,PLAYER_2;y,36);
	LoadFont("2ndMIXJudgeNum.ini")..{
		InitCommand=cmd(horizalign,left;);
		OnCommand=function(self)
...
--Miss--
t[#t+1] = Def.ActorFrame{
	InitCommand=cmd(player,PLAYER_2;y,82);
	LoadFont("2ndMIXJudgeNum.ini")..{
		InitCommand=cmd(horizalign,left;);
		OnCommand=function(self)
			self:settextf(Boo);
...
t[#t+1] = LoadFont("2ndMIXMaxComboNum")..{
	InitCommand=cmd(player,PLAYER_2;x,12;y,132;horizalign,left;);
	OnCommand=function(self)
		self:settextf(Combo);
	end;
};
