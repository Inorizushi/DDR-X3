...
t[#t+1] = Def.ActorFrame{
	...
	LoadActor("char.png")..{
		...
		GainFocusCommand=function(s) s:stoptweening():linear(0.2):addy(-10):zoom(1):Load(THEME:GetPathG("ScreenSelectGameMode","Scroll ChoicePro/char.png")) end;
		LoseFocusCommand=function(s) s:stoptweening():linear(0.2):addy(10):zoom(0.75):Load(THEME:GetPathG("ScreenSelectGameMode","Scroll ChoicePro/char dark.png")) end;
	};
	Def.ActorFrame{
