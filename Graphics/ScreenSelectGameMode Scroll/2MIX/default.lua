...
t[#t+1] = Def.ActorFrame{
	...
	Def.Sprite{
		...
		GainFocusCommand=function(s) s:stoptweening():linear(0.2):addy(-10):addx(10):zoom(1):Load(THEME:GetPathG("ScreenSelectGameMode","Scroll/2MIX/char.png")) end;
		LoseFocusCommand=function(s) s:stoptweening():linear(0.2):addy(10):addx(-10):zoom(0.75):Load(THEME:GetPathG("ScreenSelectGameMode","Scroll/2MIX/char dark.png")) end;
	};
	Def.ActorFrame{
